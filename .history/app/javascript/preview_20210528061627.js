document.addEventListener('DOMContentLoaded', function () {
  if (document.getElementById('item-image')) { // 変化監視要素
    ...
    const createImageHTML = (blob) => {
      ...
      // delHTML.setAttribute('name', 'item[images][]'); // formの配列名に合わせる
      delHTML.setAttribute('onclick', 'this.parentNode.remove()');
      ...
      imageElement.appendChild(delHTML);
      inputDiv.appendChild(inputHTML);
