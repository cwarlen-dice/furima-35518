class ItemsController < ApplicationController
  ...
  def item_params
    params.require(:itemn).permit(:name, :info, :category_id, :sales_status_id, :shipping_fee_id, :prefecture_id,
                                  :scheduled_delivery_id, :price).merge(user_id: current_user.id, image: img_params)
  end

  def img_params
    params.require(:item_img).permit(images: [])
  end
